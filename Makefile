...
PKG_SOURCES	=  tclredis.c net.c hiredis.c sds.c async.c read.c alloc.c
PKG_OBJECTS	=  tclredis.o net.o hiredis.o sds.o async.o read.o alloc.o
...
PKG_LIB_FILE	= libthiredis0.3.so
PKG_STUB_LIB_FILE = libthiredisstub0.3.a
