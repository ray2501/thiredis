...
PKG_SOURCES	=  tclredis.c net.c hiredis.c sds.c async.c read.c alloc.c sockcompat.c
PKG_OBJECTS	=  tclredis.o net.o hiredis.o sds.o async.o read.o alloc.o sockcompat.o
...
PKG_LIB_FILE	= libthiredis0.6.so
PKG_LIB_FILE8	= libthiredis0.6.so
PKG_LIB_FILE9	= libtcl9thiredis0.6.so
PKG_STUB_LIB_FILE = libthiredisstub0.6.a
...
top_builddir	= /home/danilo/Public/thiredis
