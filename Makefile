...
PKG_SOURCES	=  tclredis.c net.c hiredis.c sds.c async.c read.c
PKG_OBJECTS	=  tclredis.o net.o hiredis.o sds.o async.o read.o
...
PKG_LIB_FILE	= libthiredis0.2.so
PKG_STUB_LIB_FILE = libthiredisstub0.2.a
...
TCL_SRC_DIR	= /home/abuild/rpmbuild/BUILD/tcl8.6.8
